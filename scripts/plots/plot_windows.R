...
### load data ####
cpg_windows_min2_sum <- read.csv(file = "/home/nioo/rebeccash/PhD_grouse/wgbs_grouse/output/summary_cpg_meth_min2.csv")
load("/home/nioo/rebeccash/PhD_grouse/wgbs_grouse/output/cpg_meth_min2.RData")
...
cowplot::plot_grid(fig_hist, fig_window, ncol = 1, align = "h", axis = "l", rel_heights=c(0.8,1),  labels="auto", label_fontface = "plain", label_size = 22) -> fig

ggsave(fig, file = "plots/fig_wgbs.png", width=12, height=12)

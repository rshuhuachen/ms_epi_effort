...
ggsave(pcas, file="plots/final/supp/sfig_3_pca_plots.png", width=14, height=14)
ggsave(pcas, file="plots/final/supp/sfig_3_pca_plots.pdf", width=14, height=14, device=cairo_pdf)

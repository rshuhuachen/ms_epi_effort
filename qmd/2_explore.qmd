...
summary <- read.csv(file = "results/tables/summary_coverage_meth_unfiltered_n10.csv", nrows=10)
summary %>% kbl() %>%
  kable_classic_2()
...
![Relationship coverage and mean methylation](%22../plots/explore/plot_coverage_mean_methylation_random.png%22)
...
![PCA plots](%22../plots/explore/pca_plots_factors.png%22)

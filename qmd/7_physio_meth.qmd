...
![Volcano plot: delta mass with pre-methylation](../plots/model_out/physio/mass/volcawith_mass_dif_with_pre.png)
...
CpG site "ScEsiA3_17616__HRSCAF_20466_3956821" is located in a downstream region (gene IDs ANN28634 similar to BPI and ANN28635 similar to ID1).
...
CpG site "ScEsiA3_18278__HRSCAF_21663_133779007" is located in a gene body, exon, upstream region and 5'UTR (gene IDs ANN06028 and ANN06030). This CpG site is the same that is significantly associated with attendance rate where we include pre-lekking methylation % in the model (!).
...
CpG site "ScEsiA3_15486__HRSCAF_17393_53786697" is located in a gene body and intron (gene ID ANN20472 similar to Six4).
...
CpG site "ScEsiA3_18752__HRSCAF_22883_4031831" is located in a gene body and intron (gene ID ANN31264 similar to TET3).
...
CpG site "ScEsiA3_21976__HRSCAF_26926_4403331" is located in a down- and upstream region (gene ID ANN30832, similar to Kiaa0319l).
...
![Volcano plot: delta Microfilaria spp.  with pre-methylation](../plots/model_out/physio/microf/volcawith_microf_dif_with_pre.png)
...
CpG site "ScEsiA3_16766__HRSCAF_19082_28300178" -????
CpG site "ScEsiA3_16771__HRSCAF_19097_2512626" is located in a gene body, exon and 5'UTR (gene ID ANN30965 similar to JAM3).
...
CpG site "ScEsiA3_21978__HRSCAF_26928_6268951" is located in a TSS, promoter (gene id ANN24632 similar to PPP1R1B) and upstream region (gene ID ANN24631 similar to STARD3).
...
The third CpG site was unannotated.
...
![Volcano plot: delta trypailaria spp.  with pre-methylation](../plots/model_out/physio/trypa/volcawith_trypa_dif_with_pre.png)
...
![Volcano plot: delta IgG  with pre-methylation](../plots/model_out/physio/ig/volcawith_ig_dif_with_pre.png)
...
![Volcano plot: delta HCT with pre-methylation](../plots/model_out/physio/hct/volcawith_hct_dif_with_pre.png)

![Raw data: delta HCT with pre-methylation CpG 1](../plots/model_out/physio/hct/hct_with_pre_1.png)

CpG site "ScEsiA3_15486__HRSCAF_17393_15878140" is located in a promoter and upstream region (gene ID ANN19643 similar to GAL: Galanin peptides (C. japonica)).

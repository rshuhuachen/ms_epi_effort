...
There are 2 significant CpG sites for centrality and 6 for attendance, but none for fighting. 

Below you can find the volcano plots.

![Volcano plot reproductive effort](../plots/model_out/volcano_effort.png)


We can plot the raw data here:

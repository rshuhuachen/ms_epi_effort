...
**Which changes in CpG site methylation are associated with reproductive effort?**{#sec-effort}
...
There does seem to be some association between the two. However, we cannot statistically correct for this because of the following:
...
![Raw data fighting rate a](../plots/model_out/rawdata_plot_fight_a.png)
![Raw data fighting rate b](../plots/model_out/rawdata_plot_fight_b.png)
![Raw data fighting rate c](../plots/model_out/rawdata_plot_fight_c.png)
![Raw data fighting rate d](../plots/model_out/rawdata_plot_fight_d.png)

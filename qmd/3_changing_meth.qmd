...
**Identifying CpG sites that change over the lekking season** {#sec-change}
...
![Histogram dispersion ratio](../plots/model_out/changing_histogram_dispersion_glmer_raw.png)
![QQ plot model changing CpG sites](../plots/model_out/changing_qqplot_glmer.png)
...
![QQ-plot when filtering for ratio < 1.1](../plots/model_out/qqplot_changing_qqplot_glmer_threshold.png)
![QQ-plot when filtering for 90% percentile of the ratio](../plots/model_out/qqplot_changing_qqplot_glmer_90percentile.png)

...
![Raw data top 5 significantly changing CpG sites](../plots/model_out/changing/rawdata_top_sig.png.png){width="350" fig-align="left"}
...
```{r sig_go}
table_go_function_changing <- read_excel("../results/modeloutput/changing/GOFUNCTION_changing.xls")
...
table_go_process_changing <- read_excel("../results/modeloutput/changing/GOPROCESS_changing.xls")
...
Interestingly, there's a lot of GO terms that are related to gene regulation - fitting the story perfectly!
...
```{r sig_go}
library(readxl)
table_go_function_changing <- read_excel("../results/modeloutput/changing/GOFUNCTION_changing.xlsx")
...
table_go_process_changing <- read_excel("../results/modeloutput/changing/GOPROCESS_changing.xlsx")

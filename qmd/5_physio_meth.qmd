...
![Volcano plot physiological change](../plots/model_out/volcano_physio.png)

After also subsetting for at least an (absolute) estimate of 0.1, there is one significant CpG for delta *Microfilaria spp*, 29 for delta *Trypanosoma spp.*, 3 for delta HCT and 13 for delta IgG. As there are so many, I will only show the plots of the three most significant ones, also because not all raw data plots are as convincing.

### Microfilaria spp.
![Raw data delta Microfilaria](../plots/model_out/rawdata_plot_microf_dif_cpg_1.png)

### Trypanosoma spp.
![Raw data delta Trypanosoma top CpGs](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_top.png) 

### IgG 
![Raw data delta IgG top CpGs ](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_top.png) 

### HCT 
![Raw data delta HCT top CpGs ](../plots/model_out/igg/rawdata_plot_hct_dif.png) 

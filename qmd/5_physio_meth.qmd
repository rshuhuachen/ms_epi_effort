---
title: "Which changes in CpG site methylation are associated with changes in physiology?"
format: 
  html:
...
```{r run_model, echo=T, eval=F, code-fold=T}
### microf
# run model
...
![Raw data delta Microfilaria](../plots/model_out/rawdata_plot_microf_dif_cpg_1.png)

![Raw data delta Trypanosoma CpG 1](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_1.png)
![Raw data delta Trypanosoma CpG 2](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_2.png)
![Raw data delta Trypanosoma CpG 3](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_3.png)

![Raw data delta IgG CpG 1](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_1.png)
![Raw data delta IgG CpG 2](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_2.png)
![Raw data delta IgG CpG 3](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_3.png)

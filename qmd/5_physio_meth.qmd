...
### Microfilaria spp.
![Raw data delta Microfilaria](../plots/model_out/rawdata_plot_microf_dif_cpg_1.png){width=300 fig-align="left"}

### Trypanosoma spp.
![Raw data delta Trypanosoma top CpGs](../plots/model_out/rawdata_plot_trypa_dif_cpg_top.png) 

### IgG 
![Raw data delta IgG top CpGs ](../plots/model_out/rawdata_plot_igg_dif_cpg_top.png) 

### HCT 
![Raw data delta HCT top CpGs ](../plots/model_out/rawdata_plot_hct_dif.png){width=300 fig-align="left"}

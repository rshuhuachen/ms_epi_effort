...
![Raw data delta Trypanosoma CpG 1](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_1.png) ![Raw data delta Trypanosoma CpG 2](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_2.png) ![Raw data delta Trypanosoma CpG 3](../plots/model_out/trypa/rawdata_plot_trypa_dif_cpg_3.png)

![Raw data delta IgG CpG 1](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_1.png) ![Raw data delta IgG CpG 2](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_2.png) ![Raw data delta IgG CpG 3](../plots/model_out/igg/rawdata_plot_igg_dif_cpg_3.png)

...
This is the workflow used for the manuscript titled "Epigenetic changes associated with reproductive investment in lekking male black grouse (Lyrurus tetrix)" (in review) which can be read on EcoEvoRxiv with DOI [10.32942/X2506F](https://doi.org/10.32942/X2506F).
